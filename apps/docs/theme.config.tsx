...
const config: DocsThemeConfig = {
  darkMode: true,
  docsRepositoryBase: 'https://github.com/mikkeldamm/feelstatic/blob/core/apps/docs',
  editLink: {
  ...
  head: function useHead() {
    ...
    return (
      <>
        ...
        <meta name="og:title" content={`${config.title} – Feelstatic`} />
        <meta name="apple-mobile-web-app-title" content="Feelstatic" />
      </>
    );
  },
  logo: function Logo() {
    ...
    return (
      <>
        ...
        <span
          className="hidden font-extrabold select-none ltr:ml-2 rtl:mr-2 md:inline"
          title={`Feelstatic - your static site CMS`}
        >
          Feelstatic
        </span>
      </>
  ...
  project: {
    link: 'https://github.com/mikkeldamm/feelstatic',
  },
};
